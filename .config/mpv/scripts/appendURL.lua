-- Downloaded from <https://github.com/jonniek/mpv-scripts/blob/master/appendURL.lua>
-- and slightly adapted by Rafael Cavalcanti <https://rafaelc.org/dev>.
...
mp.register_script_message("appendURL", append)
